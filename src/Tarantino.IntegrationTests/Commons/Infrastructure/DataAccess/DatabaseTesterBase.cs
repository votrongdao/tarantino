...
namespace Tarantino.IntegrationTests.Commons.Infrastructure.DataAccess
{
	public abstract class DatabaseTesterBase
	{
		...
		protected virtual IEnumerable<string> GetTablesToDelete()
		{
			string[] tables = new string[] { "SystemUser" };
			return tables;
		}
