...
namespace Tarantino.UnitTests.Core.WebManagement.Services.Views
{
	...
	{
		[Test]
		public void Correctly_returns_html_for_non_error_non_authenticated_page_with_enabled_instance()
		{
			...
			using (mocks.Playback())
			{
				...
				string html = view.BuildHtml(string.Empty);
		...
		[Test]
		public void Correctly_returns_html_for_non_error_non_authenticated_page_with_disabled_instance()
		{
			string bodyTemplate = "body template";
		...
		[Test]
		public void Correctly_returns_html_for_non_error_authenticated_page_with_disabled_instance()
		{
			string bodyTemplate = "body template";
		...
		[Test]
		public void Correctly_returns_html_for_non_error_authenticated_page_with_enabled_instance()
		{
			string bodyTemplate = "body template";
