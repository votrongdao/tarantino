...
namespace Tarantino.UnitTests.Core.Commons.Services.DataFileManagement
{
	...
	public class DataTableReaderTester
	{
		...
		[Test, ExpectedException(ExceptionType = typeof(ApplicationException), ExpectedMessage = "'Up' is not a valid value in Tarantino.Core.Commons.Model.Enumerations.PersistenceMode")]
